...
public class TrainersController {
    ...
    public TrainerResource createUser(@Valid @RequestBody SaveTrainerResource resource) {
    ...
    public TrainerResource updateUser(@PathVariable Long userId, @Valid @RequestBody SaveTrainerResource resource) {
        Trainer user = convertToEntity(resource);
